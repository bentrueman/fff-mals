...
recovery %>% 
  ...
  knitr::kable(caption = "Estimated analyte recovery, by suspension type. Since no peaks were identified in fractograms representing the control suspension, recovery of iron was approximately 0%.")

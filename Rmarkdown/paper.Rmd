...
<!-- to do: fix link in preprint metadata -->
<!-- omit the SS sample that makes all the other LS90 fractograms hard to see? -->
...
```{r figure-zimm, fig.cap="The Zimm model described the variation in light scattering over the selected range of scattering angles, with r^2^ values of 0.983--0.999. Peaks 1 and 2 eluted at retention times of 34--35 and 44--45 minutes.", message=FALSE}
